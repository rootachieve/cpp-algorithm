...
pair<ll,pair<int,int>> back(int s, int e) {
	if (s == e) {
		return {value[s]*value[s],{s,e}};
	}
	else {
		pair<int,int> M = Min(1,n,s,e,1);
		pair<ll,pair<int,int>> Max = {Sum(1,n,s,e,1)*M.first,{s,e}};
		pair<ll, pair<int, int>> a,b;
		if (s <= M.second - 1) {
			a = back(s,M.second-1);
...
int main() {
	...
	init(1,n,1);
	pair<ll,pair<int,int>> ans = back(1,n);
